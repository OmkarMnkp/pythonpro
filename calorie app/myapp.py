...
def show_frame9():
        notebook.select(frame9)
#creating front and back buttons in each frame

Button_f = Button(frame1,text="NEXT",command=show_frame1,bootstyle="info outline").place(x=230,y=350)
button_b = Button(frame1,text="BACK",command=show_frame7,bootstyle="info outline").place(x=170,y=350)
...
button_f = Button(frame1, text="NEXT", command=show_frame2,bootstyle = "info outline").place(x=230,y=350)
button_b = Button(frame1,text="BACK",command=show_frame8,bootstyle = "info outline").place(x=170,y=350)
...
Button_f = Button(frame2,text="NEXT",command=show_frame3,bootstyle="info outline").place(x=230,y=350)
button_b = Button(frame2,text="BACK",command=show_frame1,bootstyle = "info outline").place(x=170,y=350)
...
Button_f = Button(frame3,text="NEXT",command=show_frame4,bootstyle="info outline").place(x=230,y=350)
button_b = Button(frame3,text="BACK",command=show_frame2,bootstyle = "info outline").place(x=170,y=350)
...
Button_f = Button(frame4,text="NEXT",command=show_frame5,bootstyle="info outline").place(x=230,y=350)
button_b = Button(frame4,text="BACK",command=show_frame3,bootstyle = "info outline").place(x=170,y=350)
...
Button_f = Button(frame5,text="NEXT",command=show_frame6,bootstyle="info outline").place(x=230,y=350)
button_b = Button(frame5,text="BACK",command=show_frame4,bootstyle = "info outline").place(x=170,y=350)
...
pushups = {
    ...
    'video': 'https://youtu.be/IODxDxX7oi4?si=DgmE8vL5YY-yrtO8',
...
squats = {
    ...
    'video': 'https://youtu.be/4KmY44Xsg2w?si=ImatX-5SVM1oBm8y',
    'label':"SQUATS STEPS"
}
...
lunges = {
    ...
    'video': 'https://youtu.be/wrwwXE_x-pQ?si=a0mwe8tRzesEM-vq',
    'label':"LUNGES STEPS"
}
...
planks = {
    ...
    'video': 'https://youtu.be/Ehy8G39d_PM?si=G46vcsxWStLfF3ug',
    'label':"PLANKS STEPS"
}
...
def display_exercise(exercise):
    ...
    exercise_window= Window(themename="superhero")
...
Button_f = Button(frame6,text="NEXT",command=show_frame7,bootstyle="info outline").place(x=230,y=350)
button_b = Button(frame6,text="BACK",command=show_frame5,bootstyle = "info outline").place(x=170,y=350)
...
def showinfo8():
     tmsg.showinfo("WATER TRACK","user will able to check their daily water intake")
...
ibtn = Button(frame8,text="I",bootstyle="primary outline",command=showinfo8).place(x=450,y=10)

Button_f = Button(frame7,text="NEXT",command=show_frame8,bootstyle="info outline").place(x=230,y=350)
button_b = Button(frame7,text="BACK",command=show_frame6,bootstyle = "info outline").place(x=170,y=350)
...
Label(frame9,text="REACH US AT  ",bootstyle = "default,inverse",font="comicsansms 15 bold",padding=4).grid(row=0,column=2,padx=10,pady=10)

label = Label(frame9,text="You can support us on ",bootstyle = "default",font="comicsansms 11 bold",padding=5).place(x=0,y=45)

image12= PhotoImage(file="follow-us.png")
label12 = Label(frame9, image=image12)
label12.place(x=360,y=55)

image_insta = PhotoImage(file="instagram (1).png")
label_insta = Label(frame9, image=image_insta)
label_insta.place(x=30,y=80)

image_facebbok = PhotoImage(file="facebook (1).png")
label_facebbok= Label(frame9, image=image_facebbok)
label_facebbok.place(x=30,y=130)

image_twitter = PhotoImage(file="twitter.png")
label_twitter = Label(frame9, image=image_twitter)
label_twitter.place(x=30,y=180)

image_youtube = PhotoImage(file="youtube.png")
label_youtube = Label(frame9, image=image_youtube)
label_youtube.place(x=30,y=230)

image_whatsapp = PhotoImage(file="whatsapp (1).png")
label_whatsapp = Label(frame9, image=image_whatsapp)
label_whatsapp.place(x=30,y=280)

#creating links and binding them
instagram_link = tk.Label(frame9, text="INSTAGRAM", fg="blue", cursor="hand2",font=("Helvetica", 10))
instagram_link.place(x=80,y=85)
instagram_link.bind("<Button-1>", open_instagram)

facebook_link = tk.Label(frame9, text="FACEBOOK", fg="blue", cursor="hand2",font=("Helvetica", 10))
facebook_link.place(x=80,y=135)
facebook_link.bind("<Button-1>", open_facebook)

twitter_link = tk.Label(frame9, text="TWITTER", fg="blue", cursor="hand2",font=("Helvetica", 10))
twitter_link.place(x=80,y=185)
twitter_link.bind("<Button-1>", open_twitter)

youtube_link = tk.Label(frame9, text="YOUTUBE", fg="blue", cursor="hand2",font=("Helvetica", 10))
youtube_link.place(x=80,y=235)
youtube_link.bind("<Button-1>", open_youtube)

wathsapp_link = tk.Label(frame9, text="WHATSAPP", fg="blue", cursor="hand2",font=("Helvetica", 10))
wathsapp_link.place(x=80,y=285)
wathsapp_link.bind("<Button-1>", open_whatsapp)

image11 = PhotoImage(file="follow.png")
label11 = Label(frame9, image=image11)
label11.place(x=430,y=287)


# frame 9
Label(frame8,text="WATER TRACK",bootstyle="default,inverse",font="comicsansms 15 bold",padding=4).grid(row=0,column=2,padx=10,pady=10)

label = Label(frame8,text=" let's check the amount you  drank today. ",bootstyle = "default",font="comicsansms 11 bold",padding=5).place(x=0,y=45)


# Function to add water intake
def add_intake():
    current = current_intake.get()
    total = total_intake.get()
    ...
    if current.isdigit() and total.isdigit():
        ...
        if 0 < current <= total:
            ...
            # Log the intake
            log_entry = f"Date: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}, Intake: {current} ml\n"
            ...
            messagebox.showwarning("Warning", "Invalid input. Please check your values.")
    else:
        messagebox.showwarning("Warning", "Please enter numeric values for current intake and total intake goal.")
...
imagew = PhotoImage(file="drink-water.png")
labelw = Label(frame8, image=imagew)
labelw.place(x=330, y=60)

current_intake = StringVar()
Label(frame8, text="Current Intake (ml):", bootstyle="default").place(x=18, y=85)
Entry(frame8, textvariable=current_intake).place(x=150, y=80)

total_intake = StringVar()
Label(frame8, text="Total Intake Goal (ml):", bootstyle="default").place(x=18, y=120)
Entry(frame8, textvariable=total_intake).place(x=150, y=120)

ttk.Button(frame8, text="Add Intake", command=add_intake,bootstyle="primary outline").place(x=175, y=160)

progress = ttk.Progressbar(frame8, orient="horizontal", length=300, mode="determinate")
progress.place(x=70, y=200)

log_text = Text(frame8, height=3, width=30, wrap="word", state="disabled")
log_text.place(x=120, y=220)

ttk.Button(frame8, text="Reset", command=reset_intake,bootstyle="primary outline").place(x=190, y=290)

Button_f = Button(frame8,text="NEXT",command=show_frame9,bootstyle="info outline").place(x=230,y=350)
button_b = Button(frame8,text="BACK",command=show_frame7,bootstyle = "info outline").place(x=170,y=350)
        
imagewe = PhotoImage(file="water-bottle.png")
labelwe = Label(frame8, image=imagewe)
labelwe.place(x=7,y=310)
